...
#VISUAL_EFFECT = 'visualize_energy' 
#VISUAL_EFFECT = 'visualize_scroll' 
VISUAL_EFFECT = 'visualize_spectrum' 

MIC_ON = True 

""" SC  Added 12Oct2017, can be 'visualize_energy', 'visualize_spectum' or 'visualize_sroll' """
""" allows parameterisation of visualiation setting  """


DEVICE = 'chip'

""" ADDED CHIP 12Oct2017 
...
SC 12Oct2017
'chip' means next thing co.'s C.H.I.P board. 
...
""" SC 12Oct2017, settings for C.H.I.P. """    
  
if DEVICE == 'chip':
    LED_PIN = 29   
    """ set up CHIP with DTB for SPI, use pin 29, CSIHSYNC)"""
    LED_FREQ_HZ = 800000
